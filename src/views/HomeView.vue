<template>
    ...
    <section class="w-full bg-gray-100 py-12 px-5 md:px-16 lg:px-48 text-center">
        <MotifTitleSection text="Ajoutez facilement vos ingrédients à votre liste de courses" color="blue" />
        ...
        <RouterLink to="/register" class="bg-blue-500 text-white px-6 py-3 rounded-lg text-lg font-bold shadow-md hover:bg-blue-600">
            Créer un compte
        </RouterLink>
    </section>
    <section class="w-full bg-yellow-50 py-12 px-5 md:px-16 lg:px-48 text-center">
        ...
        <RouterLink to="/ingredients" class="bg-yellow-500 text-white px-6 py-3 rounded-lg text-lg font-bold shadow-md hover:bg-yellow-600">
